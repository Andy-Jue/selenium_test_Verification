...
def coefficient_C4_C6(driver):
    ...
    wait_and_click(driver, By.XPATH, "//div[@class='ant-collapse-header']//span[contains(text(), '環境部產品碳足跡資訊網20240624')]")

    wait_and_click(driver, By.XPATH, "//div[@class='ant-collapse-header']//span[contains(text(), '01能資源')]")
...
def coefficient_C3(driver):
    ...
    wait_and_click(driver, By.XPATH, "//div[@class='ant-collapse-header']//span[contains(text(), '25運輸服務')]")
...
def coefficient_C4(driver):
    ...
    wait_and_click(driver, By.XPATH, "//div[@class='ant-collapse-header']//span[contains(text(), '27廢棄物回收處理服務')]")
