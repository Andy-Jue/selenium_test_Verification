...
def edit(driver,url):
    ...
    for i in source_type:
        if i=='移動源 C1' or i == '固定燃燒源 C1'or i == '工業製程 C1' or i== '其他關注類物質 C1':
            ...
            driver.execute_script("arguments[0].click()", element)
            time.sleep(1)
            element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, '//span[@aria-label="edit"]')))
            driver.execute_script("arguments[0].click();", element)
            time.sleep(1)
...
def input_data_C1_C2(driver, source_type,rfg_or_fire):
    ...
    for input_element in new_inputelements:
        try:
            if input_element.get_attribute("placeholder") == "請輸入" and input_element.get_attribute("id") == 'validateOnly_CarPlateNo': #車牌
                ...
                time.sleep(1)
            elif input_element.get_attribute("placeholder") == "請輸入" and input_element.get_attribute("id") == 'validateOnly_ModelNumber': #使用量單位
                input_element.send_keys(Keys.CONTROL, 'a')
                input_element.send_keys(Keys.BACKSPACE)
            ...
            #     time.sleep(1)
                ...
                if input_element.get_attribute("aria-activedescendant")=="validateOnly_Type_list_0": #車輛類別
                    element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//span[contains(text(), '公務車')]")))
                    element.click()
                    
                elif input_element.get_attribute("id")=="validateOnly_Area": #地區
                    try:
                        element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//span[contains(text(),'台灣 / 移動源 - 汽油KgCO2e/L / 2023')]"))) #移動源係數
                        element.click()
                        element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//div[contains(text(),'台灣')]")))
                        element.click()
                        element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//div[contains(text(),'移動源 - 柴油')]"))) #移動源係數
                        element.click()
                    except:
                        try:
                            element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//span[contains(text(),'台灣 / 固定源 - 汽油 KgCO2e/L / 2023')]"))) #移動源係數
                            element.click()
                            element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//div[contains(text(),'台灣')]")))
                            element.click()
                            element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//div[contains(text(),'固定源 - 柴油 ')]"))) #固定源係數
                            element.click()
                            time.sleep(0.5)
                        except:
                            element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//span[contains(text(),'台灣 / 無煙煤 KgCO2e/Kg / 2023')]"))) #移動源係數
                            element.click()
                            element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//div[contains(text(),'台灣')]")))
                            element.click()
                            element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//div[contains(text(),'天然氣 KgCO2e/M3')]"))) #製程係數
                            element.click()
                            time.sleep(0.5)
                ...
                elif input_element.get_attribute("aria-activedescendant")=="validateOnly_activityDataType_list_0": #活動數據種類
                    element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//span[contains(text(), '自動連續量測')]")))
                    element.click()
                    element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//div[contains(text(), '間歇量測')]")))
                    element.click()
                    time.sleep(1)
                elif input_element.get_attribute("aria-activedescendant")=="validateOnly_emitParaType_list_0": #排放係數種類
                    element = WebDriverWait(driver, 3).until(EC.element_to_be_clickable((By.XPATH, "//span[contains(text(), '自我/量測/質能')]")))
                    element.click()
                    element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//div[contains(text(), '同製程/設備經驗')]")))
                    element.click()
                    time.sleep(1)
                elif input_element.get_attribute("id") == "validateOnly_ARnGWPid": 
                    element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//span[contains(text(),'CO2(Carbon dioxide)')]"))) #移動源係數
                    element.click()
                    element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//div[contains(text(), 'CH4(Methane)')]")))
                    element.click()
                    time.sleep(1)
                elif input_element.get_attribute("id") == "validateOnly_Commuting":
                    input_element.click()
                    element1 = WebDriverWait(driver, 10).until(EC.visibility_of_element_located((By.XPATH,'//div[@class="ant-select-item-option-content"][2]')))
                    element1.click()     
                    time.sleep(1)
                elif input_element.get_attribute("id") == "validateOnly_TransportTypeID":
                    input_element.click()
                    element1 = WebDriverWait(driver, 10).until(EC.visibility_of_element_located((By.XPATH,'//div[@class="ant-select-item ant-select-item-option ant-pro-filed-search-select-option "][2]')))
                    element1.click()      
                    time.sleep(1)
                elif input_element.get_attribute("id") == "validateOnly_warmGasType":
                    element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//span[contains(text(),'固定燃燒')]"))) #移動源係數
                    element.click()
                    element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//div[contains(text(), '(逸散)其他逸散')]")))
                    element.click()
                    time.sleep(1)

                elif input_element.get_attribute("id") == "validateOnly_ParameterID":
                    try:
                        element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//span[contains(text(),'R-11')]"))) #移動源係數
                        element.click()
                        element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//div[contains(text(), 'R-114')]"))) #使用冷媒/製冷劑種類
                        element.click()
                        time.sleep(1)
                    except:
                        element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//span[contains(text(),'R-123')]"))) #移動源係數
                        element.click()
                        element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//div[contains(text(), 'Halon-1201')]")))
                        element.click()
                        time.sleep(1)
                elif input_element.get_attribute("id") == "validateOnly_ParameterID2": #設備類型(排放因子)
                    element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//span[contains(text(),'家用冰箱Household refrigerator')]"))) #移動源係數
                    element.click()
                    element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//div[contains(text(), '冰水機Chiller')]")))
                    element.click()
                    time.sleep(1)
                else:
                    continue  
    ...
    time.sleep(3)
    if rfg_or_fire == 1:
        catch_response(driver,'人為逸散 C1(冷媒設備) 編輯')
    elif rfg_or_fire == 2:
        catch_response(driver,'人為逸散 C1(消防設備) 編輯')
    elif rfg_or_fire == 3:
        catch_response(driver, '輸入能源上游排放 C4(輸入電力上游) 編輯')
    elif rfg_or_fire == 4:
        catch_response(driver, '輸入能源上游排放 C4(其他輸入能源上游) 編輯')
    elif rfg_or_fire == 0:
        catch_response(driver,source_type + " 編輯")
    time.sleep(2)
...
def coefficient_C4_upstreamEmissions_elec(driver):
    ...
    wait_and_click(driver, By.XPATH, "//div[@class='ant-collapse-item'][3]")
    
    wait_and_click(driver, By.XPATH, "//div[@class='ant-collapse-item']//span[contains(text(), '01能資源')]")
    
    wait_and_click(driver, By.XPATH, "//a[@class='d-block my-2 text-dark'][6]")

    element = WebDriverWait(driver, 5).until(EC.element_to_be_clickable((By.XPATH, "//tr[@class='ant-table-row ant-table-row-level-0'][2]//span[@class='ant-checkbox-inner']")))
    actions = ActionChains(driver)
    actions.move_to_element(element).click().perform()
    time.sleep(1)
    ...
    for input_element in new_inputelements:
        try:
            if input_element.get_attribute("placeholder") == "請輸入" and input_element.get_attribute("id") == 'validateOnly_GHGEvaluateItem': #評估項目
                ...
                time.sleep(1)
            elif input_element.get_attribute("placeholder") == "請輸入" and input_element.get_attribute("id") == 'validateOnly_StaffOrDepartment': #上游評估項目
                WebDriverWait(driver, 5).until(EC.visibility_of(input_element)).send_keys("使用此方式之人原測試編輯")
                time.sleep(1)
            elif input_element.get_attribute("placeholder") == "請輸入" and input_element.get_attribute("id") == 'validateOnly_JourneyNO': #上游評估項目
                WebDriverWait(driver, 5).until(EC.visibility_of(input_element)).send_keys("路程編號編輯測試")
                time.sleep(1)
            elif input_element.get_attribute("placeholder") == "請輸入" and input_element.get_attribute("id") == 'validateOnly_StartLocation': #上游評估項目
                WebDriverWait(driver, 5).until(EC.visibility_of(input_element)).send_keys("運輸起點編輯測試")
                time.sleep(1)
            elif input_element.get_attribute("placeholder") == "請輸入" and input_element.get_attribute("id") == 'validateOnly_EndLocation': #上游評估項目
                ...
                if input_element.get_attribute("aria-activedescendant")=="validateOnly_activityDataType_list_0": #活動數據種類
                    element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//span[contains(text(), '自動連續量測')]")))
                    element.click()
                    element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//div[contains(text(), '間歇量測')]")))
                    element.click()
                    ...
                    element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//span[contains(text(), '全球或區域級係數')]")))
                    element.click()
                    element = WebDriverWait(driver, 3).until(EC.element_to_be_clickable((By.XPATH, "//div[contains(text(), '國家級係數')]")))
                    element.click()
                    time.sleep(1)
                elif input_element.get_attribute("id") == "validateOnly_DataAttribute":
                    element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//span[contains(text(), '基於假設情境而來')]")))
                    element.click()
                    element = WebDriverWait(driver, 3).until(EC.element_to_be_clickable((By.XPATH, "//div[contains(text(), '可獲得特定廠址數據')]")))
                    element.click()
                    time.sleep(1)
                elif input_element.get_attribute("id") == "validateOnly_Commuting": #員工差旅交通方式
                    element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//span[contains(text(), '汽車-汽油')]")))
                    element.click()
                    element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//div[contains(text(), '計程車')]")))
                    element.click()
                    time.sleep(1)
                elif input_element.get_attribute("id") == "validateOnly_TransportTypeID": #運輸方式
                    element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//span[contains(text(), '陸運,運輸 貨車 3.5-7.5噸 EURO5/RER S ')]")))
                    element.click()
                    element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//div[contains(text(), '陸運,無區分')]")))
                    element.click()
                    time.sleep(1)
                else:
                    continue  
...
def input_data_C4(driver, source_type,elec_other):
    ...
    for input_element in new_inputelements:
        try:
            if input_element.get_attribute("placeholder") == "請輸入" and input_element.get_attribute("id") == 'validateOnly_MaterialNo': #料號
                input_element.send_keys(Keys.CONTROL, 'a')
                input_element.send_keys(Keys.BACKSPACE)
            ...
            elif input_element.get_attribute("placeholder") == "請輸入" and input_element.get_attribute("id") == 'validateOnly_Scenario': #上游評估項目
...
def workhour_edit(driver,url):
    ...
    element.click()
    time.sleep(1)
    element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//span[contains(text(), '自我/量測/質能')]")))
    element.click()
    element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//div[contains(text(), '同製程/設備經驗')]")))
    element.click()
