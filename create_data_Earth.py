...
def source_input_Earth(driver,url):
    source_type = [
...
def coefficient_C4_C6(driver):
    ...
    wait_and_click(driver, By.XPATH, "//div[@class='ant-collapse-item']//span[contains(text(), '環境部碳足跡資訊網20240624')]")
...
def coefficient_C4(driver):
    ...
    wait_and_click(driver, By.XPATH, "//div[@class='ant-collapse-item']//span[contains(text(), '26廢棄物回收處理服務')]")
        ...
        try:
            if input_element.get_attribute("placeholder") == "請輸入" and input_element.get_attribute(
                ...
                if rfg_or_fire == 3:
                    ...
                    WebDriverWait(driver, 5).until(EC.visibility_of(input_element)).send_keys(
