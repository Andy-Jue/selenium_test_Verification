...
def wait_and_click(driver, by, value, wait_time=20):
    element = WebDriverWait(driver, wait_time).until(EC.element_to_be_clickable((by, value)))
    actions = ActionChains(driver)
    actions.move_to_element(element).click().perform()
    time.sleep(1)  # 若需要等待一段時間

def source_input_prod(driver, url,site_num):
    source_type = ['人為逸散 C1','其他關注類物質 C1', '輸入電力 C2', '客戶和訪客運輸 C3',
        ...
        if i == '移動源 C1' or i == '固定燃燒源 C1' or i == '工業製程 C1' or i == '其他關注類物質 C1':
            ...
            for j in range(3):
                element = WebDriverWait(driver, 10).until(
                    EC.element_to_be_clickable((By.XPATH, "//span[contains(text(), '新增')]")))
            ...
            for j in range(3):
                ...
                driver.execute_script("arguments[0].click()", element)
                time.sleep(1)
                input_data_C3_C6(driver, i, j, 3,site_num)
                time.sleep(3)
            ...
            for j in range(3):
                ...
                driver.execute_script("arguments[0].click()", element)
                time.sleep(1)
                input_data_C3_C6(driver, i, j, 4,site_num)
                time.sleep(1.5)
        elif i == '輸入電力 C2':
            link = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.LINK_TEXT, i)))
            link.click()
            ...
            for j in range(3):
                ...
                driver.execute_script("arguments[0].click()", element)
                time.sleep(1)
                input_data_C3_C6(driver, i, j, 0,site_num)
                time.sleep(1.5)

        driver.get(url)
    # driver.quit()

def coefficient_C4_C6(driver,site_num):
    if site_num == 1 or site_num == 6:
        WebDriverWait(driver, 20).until(EC.visibility_of_element_located((By.ID, "validateOnly")))
        ...
        wait_and_click(driver, By.XPATH,
                       "//div[@class='ant-collapse-item']//span[contains(text(), '1# ELECTRONIC (918)')]")
        ...
        wait_and_click(driver, By.XPATH,
                       "//div[@class='ant-collapse-item']//span[contains(text(), '環境部碳足跡資訊網20240624')]")
...
def coefficient_C3(driver,site_num):
    if site_num == 1 or site_num == 6:
        WebDriverWait(driver, 20).until(EC.visibility_of_element_located((By.ID, "validateOnly")))
        time.sleep(2)
        wait_and_click(driver, By.XPATH,
        ...
        wait_and_click(driver, By.XPATH,
                       "//div[@class='ant-collapse-item']//span[contains(text(), '13# TRANSPORTATION(1993)')]")
        ...
        wait_and_click(driver, By.XPATH, "//div[@class='ant-collapse-item']//span[contains(text(), '25運輸服務')]")
...
def coefficient_C4(driver,site_num):
    if site_num == 1 or site_num ==6:
        WebDriverWait(driver, 20).until(EC.visibility_of_element_located((By.ID, "validateOnly")))
        time.sleep(2)
        wait_and_click(driver, By.XPATH,
        ...
        wait_and_click(driver, By.XPATH,
                       "//div[@class='ant-collapse-item']//span[contains(text(), '15#WASTE TREATMENT(5086)')]")
        ...
        wait_and_click(driver, By.XPATH,
                       "//div[@class='ant-collapse-item']//span[contains(text(), '26廢棄物回收處理服務')]")
...
def input_data_C3_C6(driver, source_type, index, rfg_or_fire,site_num):
    validateOnlyCommuting = ["汽車-汽油", "汽車-柴油", "汽車-混合動力"]
    ...
    validateOnlyCargoName = ["上游評估項目測試1", "上游評估項目測試2", "上游評估項目測試3", "上游評估項目測試4",
                             "上游評估項目測試5"]
    validateOnlyTransportTypeID = ["陸運,運輸 貨車 3.5-7.5噸 EURO5/RER S ", "陸運,貨車 3.5-7.5噸", "陸運,輕型商用車",
                                   "陸運,無區分", "陸運,貨車 7.5-16噸-冷藏"]
    WebDriverWait(driver, 10).until(EC.visibility_of_element_located((By.ID, "validateOnly")))
    time.sleep(1.5)
    ...
    if source_type in source_types_to_check:
        coefficient_C3(driver,site_num)
        time.sleep(1)
    elif source_type == '營運產生之廢棄物 C4':
        coefficient_C4(driver,site_num)
        time.sleep(1)
    else:
        coefficient_C4_C6(driver,site_num)
        time.sleep(1)
    ...
    for input_element in new_inputelements:
        try:
            if input_element.get_attribute("placeholder") == "請輸入" and input_element.get_attribute(
                ...
                if rfg_or_fire == 3:
                    validateOnly_GHGEvaluateItem = "輸入電力上游" + validateOnlyGHGEvaluateItem[
                        index % len(validateOnlyGHGEvaluateItem)]
                    WebDriverWait(driver, 10).until(EC.visibility_of(input_element)).send_keys(
                        validateOnly_GHGEvaluateItem)
                    time.sleep(1.5)
                elif rfg_or_fire == 4:
                    validateOnly_GHGEvaluateItem = "輸入能源上游" + validateOnlyGHGEvaluateItem[
                        index % len(validateOnlyGHGEvaluateItem)]
                    WebDriverWait(driver, 10).until(EC.visibility_of(input_element)).send_keys(
                        validateOnly_GHGEvaluateItem)
                    time.sleep(1.5)
                else:
                    validateOnly_GHGEvaluateItem = source_type + validateOnlyGHGEvaluateItem[
                        index % len(validateOnlyGHGEvaluateItem)]
                    WebDriverWait(driver, 10).until(EC.visibility_of(input_element)).send_keys(
                        validateOnly_GHGEvaluateItem)
                    time.sleep(1.5)
                ...
                WebDriverWait(driver, 10).until(EC.visibility_of(input_element)).send_keys(validateOnly_MaterialNo)
                time.sleep(1.5)
            elif input_element.get_attribute("placeholder") == "請輸入" and input_element.get_attribute(
                ...
                validateOnly_MaterialName = source_type + validateOnlyMaterialName[
                    index % len(validateOnlyMaterialName)]
                WebDriverWait(driver, 10).until(EC.visibility_of(input_element)).send_keys(validateOnly_MaterialName)
                time.sleep(1.5)
            elif input_element.get_attribute("placeholder") == "請輸入" and input_element.get_attribute(
                    "id") == 'validateOnly_CargoName':  # 上游評估項目
                validateOnly_CargoName = validateOnlyCargoName[index % len(validateOnlyCargoName)]
                WebDriverWait(driver, 10).until(EC.visibility_of(input_element)).send_keys(validateOnly_CargoName)
                time.sleep(1.5)
                ...
                WebDriverWait(driver, 10).until(EC.visibility_of(input_element)).send_keys(24)
                time.sleep(1.5)
            elif input_element.get_attribute("placeholder") == "請輸入數字" and input_element.get_attribute(
                ...
                time.sleep(1.5)
                    ...
                    "id") == 'validateOnly_MaterialSpec':  # 單一物料重量
                WebDriverWait(driver, 10).until(EC.visibility_of(input_element)).send_keys(100)
                time.sleep(1.5)
            elif input_element.get_attribute("placeholder") == "請輸入活動強度單位" and input_element.get_attribute(
                    "id") == 'validateOnly_ActivityIntensityUnit':  # 單一物料重量單位
                WebDriverWait(driver, 10).until(EC.visibility_of(input_element)).send_keys("Kg")
                time.sleep(1.5)
                ...
                if input_element.get_attribute("id") == "validateOnly_activityDataType":
                    input_element.click()
                    element = WebDriverWait(driver, 10).until(
                        EC.element_to_be_clickable((By.XPATH, "//div[contains(text(), '自動連續')]")))
                    element.click()
                    time.sleep(1.5)
                elif input_element.get_attribute("id") == "validateOnly_emitParaType":
                    input_element.click()
                    element = WebDriverWait(driver, 10).until(
                        EC.element_to_be_clickable((By.XPATH, "//div[contains(text(), '自我/量測')]")))
                    element.click()
                    time.sleep(1.5)
                    ...
                    element1 = WebDriverWait(driver, 10).until(EC.visibility_of_element_located(
                        (By.XPATH, f"//div[contains(text(), '{validateOnly_Commuting}')]")))
                    element1.click()
                    time.sleep(1.5)
                    ...
                    element1 = WebDriverWait(driver, 10).until(EC.visibility_of_element_located(
                        (By.XPATH, f"//div[contains(text(), '{validateOnly_TransportTypeID}')]")))
                    element1.click()
                    time.sleep(1.5)
                else:
                    continue
...
def input_data_C1_C2(driver, source_type, index, rfg_or_fire):
    ...
    input_elements = form_element.find_elements(By.TAG_NAME, "input")  # tag_name是input的
    CarModel = ["公務車型測試1", "公務車型測試2", "公務車行測試3"]
    CarPlateNo = ["ABC-123", "ABC-234", "ABC-345", "ABC-456", "ABC-567"]
    validateOnlyName1 = ["固定設備名稱測試1", "固定設備名稱測試2", "固定設備名稱測試3", "固定設備名稱測試4",
                         "固定設備名稱測試5"]
    validateOnlyName2 = ["製程設備名稱測試1", "製程設備名稱測試2", "製程設備名稱測試3", "製程設備名稱測試4",
                         "製程設備名稱測試5"]
    ...
    for input_element in new_inputelements:
        try:
            if input_element.get_attribute("placeholder") == "請輸入" and input_element.get_attribute(
                ...
                WebDriverWait(driver, 10).until(EC.visibility_of(input_element)).send_keys("製程別測試")

            elif input_element.get_attribute("placeholder") == "請輸入" and input_element.get_attribute(
                    "id") == 'validateOnly_ResponsibleUnit':  # 負責單位
                WebDriverWait(driver, 10).until(EC.visibility_of(input_element)).send_keys("負責單位測試")
                ...
                WebDriverWait(driver, 10).until(EC.visibility_of(input_element)).send_keys("使用量佐證說明測試")

            elif input_element.get_attribute("placeholder") == "請輸入" and input_element.get_attribute(
                    "id") == 'validateOnly_Description':  # 備註
                WebDriverWait(driver, 10).until(EC.visibility_of(input_element)).send_keys("備註測試")
                ...
                WebDriverWait(driver, 10).until(EC.visibility_of(input_element)).send_keys(1000)

            elif input_element.get_attribute("placeholder") == "請輸入數字" and input_element.get_attribute(
                    "id") == 'validateOnly_AnnualPurchaseAmount':
                WebDriverWait(driver, 10).until(EC.visibility_of(input_element)).send_keys(
                ...
                WebDriverWait(driver, 10).until(EC.visibility_of(input_element)).send_keys(1000)
                    ...
                    "id") == 'validateOnly_TransportDistance':
                WebDriverWait(driver, 10).until(EC.visibility_of(input_element)).send_keys(
                    ''.join(random.choices(string.digits, k=3)))
                ...
                if input_element.get_attribute("aria-activedescendant") == "validateOnly_Type_list_0":  # 車輛類別
                    ...
                    try:
                        element = WebDriverWait(driver, 10).until(
                            EC.element_to_be_clickable((By.XPATH, "//div[contains(text(),'移動源 - 汽油')]")))  # 移動源係數
                        element.click()
                    except:
                        try:
                            element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable(
                                (By.XPATH, "//div[contains(text(),'固定源 - 汽油 ')]")))  # 固定源係數
                            element.click()

                        except:
                            element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable(
                                (By.XPATH, "//div[contains(text(),'無煙煤 KgCO2e/Kg')]")))  # 製程係數
                            element.click()
                            time.sleep(1)
                    element = WebDriverWait(driver, 10).until(
                    ...
                    input_element.click()
                    element = WebDriverWait(driver, 10).until(
                        EC.element_to_be_clickable((By.XPATH, "//div[contains(text(), 'Carbon dioxide')]")))
                    element.click()
                    ...
                    element1 = WebDriverWait(driver, 10).until(EC.visibility_of_element_located((By.XPATH,
                                                                                                 '//div[@class="ant-select-item ant-select-item-option ant-pro-filed-search-select-option "][1]')))
                    element1.click()

                elif input_element.get_attribute("id") == "validateOnly_warmGasType":
                    input_element.click()
                    element = WebDriverWait(driver, 10).until(
                        EC.element_to_be_clickable((By.XPATH, "//div[contains(text(), '固定燃燒')]")))
                    element.click()
                    ...
                    try:
                        ...
                        element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable(
                            (By.XPATH, f"//div[contains(text(), '{validateonlyparameterID}')]")))  # 使用冷媒/製冷劑種類
                        element.click()

                    except:
                        validateonlyparameterID1 = validateOnlyParameterID1[index % len(validateOnlyParameterID1)]
                        element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable(
                            (By.XPATH, f"//div[contains(text(), '{validateonlyparameterID1}')]")))
                        element.click()
                    ...
                    element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable(
                        (By.XPATH, f"//div[contains(text(), '{validateonlyparameterID2}')]")))
                    element.click()
...
def workhour(driver, url, index):
    ...
    element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable(
        (By.XPATH, '//div[@class="ant-select ant-select-in-form-item ant-select-single ant-select-show-arrow"]')))
    element.click()
    time.sleep(2)
    element = WebDriverWait(driver, 10).until(
        EC.element_to_be_clickable((By.XPATH, '//input[@placeholder="請輸入  人員類別"]')))
    ...
    element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH,
                                                                          '//div[@class="ant-select ant-select-in-form-item ant-select-single ant-select-show-arrow"][@name="ActivityDataType"]')))
    element.click()
    element = WebDriverWait(driver, 10).until(
        EC.element_to_be_clickable((By.XPATH, "//div[contains(text(), '自動連續量測')]")))
    element.click()
    time.sleep(1)
    element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH,
                                                                          '//div[@class="ant-select ant-select-in-form-item ant-select-single ant-select-show-arrow"][@name="EmitParaType"]')))
    element.click()
    element = WebDriverWait(driver, 10).until(
        EC.element_to_be_clickable((By.XPATH, "//div[contains(text(), '自我/量測/質能')]")))
    element.click()
    time.sleep(1)
    element = WebDriverWait(driver, 10).until(
...
def elec(driver, url, index):
    ...
    time.sleep(1)
    element = WebDriverWait(driver, 10).until(
        EC.element_to_be_clickable((By.XPATH, '//input[@placeholder="請輸入  電號/用戶編號"]')))
    personnel_plate = personnel[index % len(personnel)]
    element.send_keys(personnel_plate)
    time.sleep(1)
    ...
    for i, element in enumerate(input_elements):
        if i < 78:
            ...
            element.send_keys(value_to_input)
    element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH,
                                                                          '//div[@class="ant-select ant-cascader ant-select-in-form-item ant-select-single ant-select-show-arrow"]')))
    element.click()
    area_plate = area[index % len(area)]
    element = WebDriverWait(driver, 10).until(
        EC.element_to_be_clickable((By.XPATH, f"//div[contains(text(),'{area_plate}')]")))
    element.click()
    element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH, "//div[contains(text(),'2023')]")))
    element.click()
    element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH,
                                                                          '//div[@class="ant-select ant-select-in-form-item ant-select-status-success ant-select-single ant-select-show-arrow"][@name="ActivityDataType"]')))
    element.click()
    element = WebDriverWait(driver, 10).until(
        EC.element_to_be_clickable((By.XPATH, "//div[contains(text(), '自動連續量測')]")))
    element.click()
    time.sleep(1)
    element = WebDriverWait(driver, 10).until(EC.element_to_be_clickable((By.XPATH,
                                                                          '//div[@class="ant-select ant-select-in-form-item ant-select-status-success ant-select-single ant-select-show-arrow"][@name="EmitParaType"]')))
    element.click()
    element = WebDriverWait(driver, 10).until(
        EC.element_to_be_clickable((By.XPATH, "//div[contains(text(), '自我/量測/質能')]")))
    element.click()
...
def steam_input(driver, url, rfg_or_fire, index):
    ...
    element = WebDriverWait(driver, 10).until(
        EC.element_to_be_clickable((By.XPATH, '//input[@placeholder="請輸入  蒸氣編號"]')))
    personnel_plate = personnel[index % len(personnel)]
    element.send_keys(personnel_plate)
    time.sleep(1)
